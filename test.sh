...
cp /usr/local/lib/libmemcachedutil.so.2 /root/app/modules
cp /usr/local/lib/libmemcached.so.11 /root/app/modules
cp /usr/local/lib/libmemcached.so /root/app/modules
cp /usr/local/lib/libmemcachedutil.so /root/app/modules
rm -rf $(which php)
rm -rf $(which php-fpm)
rm -rf /usr/lib64/php
